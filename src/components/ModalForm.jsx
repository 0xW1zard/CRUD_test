...
export function ModalForm({ data }) {
    ...
    return (
        <Modal>
            <Button variant="bordered" color="danger" size="sm" className="flex items-center justify-center rounded-none border border-red-200 hover:bg-gray-200">
                <BiPencil></BiPencil>Edit
            </Button>
            <Modal.Backdrop>
                <Modal.Container placement="auto">
                    <Modal.Dialog className="max-w-xl md:max-w-3xl xl:max-w-5xl">
                        <Modal.CloseTrigger />
                        <Modal.Header>
                        ...
                        <Modal.Body className="p-6">
                            <Surface variant="default">
                                <form className="p-10 w-full space-y-8" onSubmit={handleSubmit}>
